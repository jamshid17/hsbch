...
class Item(Base):
    ...
    assignments: Mapped[list["Assignment"]] = relationship("Assignment", back_populates="item", cascade="all, delete-orphan")
...
class Person(Base):
    ...
    assignments: Mapped[list["Assignment"]] = relationship("Assignment", back_populates="person", cascade="all, delete-orphan")
...
class Assignment(Base):
    ...
    person_id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), ForeignKey("people.id", ondelete="CASCADE"), primary_key=True)
